...
/**
 * This file can be found at <a href="https://gist.github.com/mjansen4857/a8024b55eb427184dbd10ae8923bd57d#file-localadstarak-java">...</a>
 */
public class LocalADStarAK implements Pathfinder {
   ...
   */
  @Override public boolean isNewPathAvailable() {
   ...
   */
  @Override public PathPlannerPath getCurrentPath(PathConstraints constraints, GoalEndState goalEndState) {
    if (!Logger.hasReplaySource()) {
   ...
   */
  @Override public void setStartPosition(Translation2d startPosition) {
    if (!Logger.hasReplaySource()) {
   ...
   */
  @Override public void setGoalPosition(Translation2d goalPosition) {
    if (!Logger.hasReplaySource()) {
   ...
   */
  @Override public void setDynamicObstacles(
